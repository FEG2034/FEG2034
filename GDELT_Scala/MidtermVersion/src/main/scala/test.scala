...
import org.apache.spark.graphx.{Graph, GraphXUtils, PartitionStrategy}
...
object SynthBenchmark {
    ...
    def main(args: Array[String]) {
        ...
        options.foreach {
            ...
            case ("partStrategy", v) => partitionStrategy = Some(PartitionStrategy.EdgePartition2D/*fromString(v)*/)
        ...
        if (app == "pagerank") {
            ...
            val totalPR = unpartitionedGraph.pageRank(0.0001).vertices.map(_._2).sum()
